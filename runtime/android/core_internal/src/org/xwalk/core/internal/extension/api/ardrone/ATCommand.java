...
public class ATCommand implements Comparable<ATCommand> {
    ...
    public String getCommandName() {
        return this.mCommand.getCommandName();
    }
    ...
    public int getPriority() {
        return this.mCommand.getPriority();
    }
    
    private Object[] getParameters() {
        return this.mCommand.getParameters();
    }
...
class ConfigCommand extends BaseCommand {
    ...
    @Override
    Object[] getParameters() {
        return new Object[] {this.mName, this.mValue};
    }
}
...
class AnimCommand extends BaseCommand {
    ...
    protected Object[] getParameters() {
        return new Object[] {this.mAnimation, this.mDuration};
    }
}
...
class LedCommand extends BaseCommand {
    ...
    @Override
    protected Object[] getParameters() {
        return new Object[] {this.mAnimation, this.mFrequence, this.mDuration};
    }
}
...
class PcwdCommand extends BaseCommand {
    ...
    protected Object[] getParameters() {
        ...
        return new Object[] {mode, this.mLeftRrightTilt, this.mFrontBackTilt,
                this.mVerticalSpeed, this.mAngularSpeed};
    }
}
...
class MoveCommand extends PcwdCommand {
    MoveCommand(boolean combinedYawEnable, float leftRightTilt, float frontBackTilt,
        ...
        super(false);
        this.mCombinedYawEnable = combinedYawEnable;
        this.mLeftRrightTilt = leftRightTilt;
        this.mFrontBackTilt = frontBackTilt;
        this.mVerticalSpeed = verticalSpeed;
